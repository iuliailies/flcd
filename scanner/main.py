...
class Main:
    ...
    def run(self):
        parseFile()
        exceptions = []
        faConstant = FiniteAutomata('FA_constants.in')
        faIdentifier = FiniteAutomata('FA_identifiers.in')

        with open("programs/p1.txt", 'r') as file:
            lineCounter = 0
            for line in file:
                lineCounter += 1
